...
import { Building2, Users, FileText, Search, ShieldCheck, TrendingUp } from "lucide-react";
...
export default function AdminDashboard() {
  ...
  useEffect(() => {
    async function fetchAdminData() {
      ...
      const [businessesRes, usersRes, taxFormsRes] = await Promise.all([
      ...
      const userData = (usersRes.data || []) as UserProfile[];
          ...
          <TabsContent value="users">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  View registered users (sensitive data masked for security)
                </CardDescription>
              </CardHeader>
              <CardContent>
                <div className="overflow-x-auto">
